...
import model from '../models/personasModel.js';
import { getClientePerfil, updateClientePerfil, getTrabajadorPerfil, updateTrabajadorPerfil, setPersonaActiva, createTrabajador, updateTrabajadorAdmin } from '../models/personasModel.js';
...
export const adminEditarTrabajador = async (req, res) => {
  try {
    const { id } = req.params; const { password, ...fields } = req.body;
